...
public class ServerWorker implements Runnable,Serializable {
    ...
    public void leilao(String server){
        ...
        Leilao l;
        try {
            if (this.leilaoLarge.isEmpty()){
                if (server.equals("large")) id = this.large.alugaServer(server);
                else if (server.equals("normal")) id = this.normal.alugaServer(server);
                else id = this.micro.alugaServer(server);
                this.leilaoLarge.setIdServer(id);
            }
            ...
            this.leilaoLarge.multicast("Entrou novo user", mail);
        //    String value = "ok";
            boolean terminado = this.leilaoLarge.isTerminado();
        //    System.out.println(this.leiloes);
            while(!terminado){
         //       terminado=this.leiloes.isTerminado(server);
         ...
         /*   if (terminado && this.leiloes.isWinner(mail,server)){
                ...
                if (server.equals("large")) this.large.libertaServidor(id, server);
                else if (server.equals("normal")) this.normal.libertaServidor(id, server);
                else this.micro.libertaServidor(id, server);
            }
